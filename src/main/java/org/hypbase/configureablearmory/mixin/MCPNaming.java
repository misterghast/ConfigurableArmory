    ...
    static
    {
        if(mcp()) {
            try {
                ...
                System.out.println("[Configurable Armory] Error getting mappings from Gradlew SRG, falling back to mcp folder.");
    ...
    private static class MCPFileParser implements LineProcessor<Map<String, String>> {
        ...
        public boolean processLine(String line) throws IOException {
            ...
            try {
                ...
                throw new IOException("Invalid mappings file!");
            }
